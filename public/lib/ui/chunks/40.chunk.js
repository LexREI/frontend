(window.webpackJsonp = window.webpackJsonp || []).push([
  [40],
  {
    ...
    1509: function (e, n, t) {
      (n = e.exports = t(28)(!1)).push([
        e.i,
        '.open.MeasurementOverlay{visibility:visible}.closed.MeasurementOverlay{visibility:hidden}:host{display:inline-block;container-type:inline-size;width:100%;height:100%;overflow:hidden}@media(min-width:901px){.App:not(.is-web-component) .hide-in-desktop{display:none}}@container (min-width: 901px){.hide-in-desktop{display:none}}@media(min-width:641px)and (max-width:900px){.App:not(.is-in-desktop-only-mode):not(.is-web-component) .hide-in-tablet{display:none}}@container (min-width: 641px) and (max-width: 900px){.App.is-web-component:not(.is-in-desktop-only-mode) .hide-in-tablet{display:none}}@media(max-width:640px)and (min-width:431px){.App:not(.is-web-component) .hide-in-mobile{display:none}}@container (max-width: 640px) and (min-width: 431px){.App.is-web-component .hide-in-mobile{display:none}}@media(max-width:430px){.App:not(.is-web-component) .hide-in-small-mobile{display:none}}@container (max-width: 430px){.App.is-web-component .hide-in-small-mobile{display:none}}.always-hide{display:none}.MeasurementOverlay{position:absolute;z-index:95;border-radius:4px;box-shadow:0 0 3px 0 var(--document-box-shadow);background:var(--component-background);flex-direction:column;bottom:60px;right:14px;font-size:16px;min-width:215px;padding:6px}@media(max-width:640px){.App:not(.is-in-desktop-only-mode):not(.is-web-component) .MeasurementOverlay{bottom:8px;right:8px;padding:8px;font-size:14px}}@container (max-width: 640px){.App.is-web-component:not(.is-in-desktop-only-mode) .MeasurementOverlay{bottom:8px;right:8px;padding:8px;font-size:14px}}.MeasurementOverlay>*{margin:6px}.MeasurementOverlay.transparent{opacity:.5;pointer-events:none}.measurement__value{display:flex;flex-direction:row}.measurement__value .distance-show{margin-left:3px;cursor:pointer}.measurement__title{display:flex;justify-content:center;align-items:center}.measurement__title .measurement__icon{margin-right:5px}.measurement__deltas{display:flex;justify-content:space-between}.lineMeasurementInput{width:50px;margin-left:4px}.length_input{margin-bottom:3px}.angle_input{margin-top:3px}.angle_input .lineMeasurementInput{width:65px}',
        '',
      ]),
    ...
    1727: function (e, n, t) {
      ...
      function b(e) {
        return (function (n) {
          switch (Object(m.g)(e.annotation)) {
            case 'ellipse':
      ...
      function g(e) {
        ...
        return o.a.createElement(
          ...
          o.a.createElement(
            ...
            i('option.measurementOverlay.scale'),
            ': ',
            ''
              .concat(l[0][0], ' ')
              .concat(l[0][1], ' = ')
      ...
      (b.propTypes = {
        ...
        (g.propTypes = b.propTypes);
      var x = Object(v.a)()(b),
        E = t(362);
      function w(e) {
        var n = Object(m.g)(e.annotation),
          t = Object(m.e)(n).icon,
          a = Object(E.a)().t,
          i = p.a.getAnnotationsList().filter(function (e) {
      ...
      w.propTypes = { annotation: u.a.object.isRequired };
      var O = w,
        _ = t(5);
      t(1508);
      function M() {
      ...
      var R = { annotation: u.a.object },
        T = function (e) {
          var n,
            ...
            c = Object(h.d)(),
            u = j(Object(a.useState)({ x: 0, y: 0 }), 2),
            v = u[0],
            y = u[1],
            b = j(Object(a.useState)(!1), 2),
            g = b[0],
            E = b[1],
            w = j(Object(a.useState)(!1), 2),
            A = w[0],
            R = w[1],
            ...
            k = function (e) {
              return (
                !(function (e) {
                  return ['countMeasurement'].includes(Object(m.g)(e));
                })(e) &&
                S.some(function (n) {
                  return n.validate(e);
                })
            ...
            D = function (e) {
              ...
              if (t) {
                var a,
                  o = (function (e, n) {
                    ...
                    return (
                      ...
                      t >= o.left && t <= o.right && a >= o.top && a <= o.bottom
                    );
                  })(e, C.current);
                if (A) {
                  var i,
                    r,
                    l =
                      null === (i = (r = p.a.getToolMode()).getDrawMode) ||
                      void 0 === i
                        ? void 0
                        : i.call(r);
                  a = o && 'twoClicks' !== l;
                ...
                k(n.annotation) &&
                  (c(d.a.openElement(_.a.MEASUREMENT_OVERLAY)), R(!0));
            },
            I = function (e, n) {
              'add' === n &&
                1 === e.length &&
                e[0] === t &&
                c(d.a.closeElement(_.a.MEASUREMENT_OVERLAY)),
                'modify' === n && 1 === e.length && e[0] === t && s();
            };
          return (
            Object(a.useEffect)(function () {
              return (
                p.a.addEventListener('mouseMove', D),
                p.a.addEventListener('annotationChanged', I),
                function () {
                  p.a.removeEventListener('mouseMove', D),
                    p.a.removeEventListener('annotationChanged', I);
                }
              );
            }, []),
            i || !t
                  ...
                  o.a.createElement(
                    ...
                    (function (e, n) {
                      return k(e)
                        ...
                        : 'countMeasurement' === n
                          ? o.a.createElement(O, { annotation: e })
                          : void 0;
                    })(t, L)
                  )
                )
