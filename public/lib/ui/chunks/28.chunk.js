  ...
  [28],
  {
    ...
    1718: function (e, t, n) {
      ...
      var r = n(0),
                ...
                var r = i === e.id,
                  ...
                  c = (function (e) {
                    if (e.hasOwnProperty('thumbnail')) {
                      var t = null,
                        n = e.thumbnail;
                      n.url ? (t = n.url) : n.toDataURL && (t = n.toDataURL());
                      var r = o.a.createElement('img', {
                        src: t,
        ...
        b = n(142),
        h = n(21),
        y = (n(65), n(53), n(32), n(131), n(128), n(371)),
        g = (n(1428), n(1577), n(1473)),
        v = n(58),
        w = n(367);
      function x(e) {
        return (x =
      ...
      var k = o.a.forwardRef(function (e, t) {
        var n = e.closeThisModal,
          a = e.clearLoadedFile,
          i = e.pageIndicesToReplace,
          l = e.sourceDocument,
          c = e.replacePagesHandler,
          u = e.documentInViewer,
          s = e.closeModalWarning,
          m = S(Object(d.a)(), 1)[0],
          f = S(
            Object(r.useState)(
              i.map(function (e) {
          ...
          b = f[0],
          x = f[1],
          E = S(Object(r.useState)({}), 2),
          j = E[0],
          k = E[1],
          A = S(Object(r.useState)(!0), 2),
          N = A[0],
          L = A[1],
          T = S(Object(r.useState)(null), 2),
          F = T[0],
          I = T[1],
          R = S(Object(r.useState)(null), 2),
          D = R[0],
          M = R[1],
          _ = S(Object(r.useState)(0), 2),
          C = _[0],
          H = _[1],
          B = S(Object(r.useState)(''), 2),
          G = B[0],
          W = B[1],
          z = Object(v.d)(),
          U = Object(v.b)();
        Object(r.useEffect)(
          function () {
            if (l) {
              for (var e = l.getPageCount(), t = {}, n = 1; n <= e; n++)
                t[n] = !0;
              k(t);
            }
          },
          ...
          Object(r.useEffect)(
            function () {
              ...
              if (l) {
                var t = l.getPageCount();
                H(t), I(e(l.getFilename())), M(e(u.getFilename()));
              }
            },
            [l]
          );
        var V = function () {
            var e = [];
            for (var t in j) j[t] && e.push(parseInt(t));
            return e;
          },
          $ = function () {
            s();
        ...
        return o.a.createElement(
          ...
          o.a.createElement(
            ...
            o.a.createElement('div', { className: 'page-replacement-divider' }),
            o.a.createElement(
              'div',
                ...
                o.a.createElement(
                  ...
                  o.a.createElement(y.a, {
                    ...
                    onError: function (e) {
                      e &&
                        W(
                          ''.concat(m('message.errorPageNumber'), ' ').concat(Y)
                        );
                    },
                  }),
                  G &&
              ...
              o.a.createElement(
                'div',
                { className: p()('modal-body-container', { isLoading: N }) },
                o.a.createElement(g.a, {
                  document: l,
                  onThumbnailSelected: function (e) {
                    void 0 === j[e] ? (j[e] = !0) : (j[e] = !j[e]), k(P({}, j));
                  },
                  selectedThumbnails: j,
                  onfileLoadedHandler: L,
                })
              )
            ),
            o.a.createElement('div', { className: 'page-replacement-divider' }),
            o.a.createElement(
              'div',
              { className: p()('footer', { isFileSelected: !N }) },
              o.a.createElement(
                'button',
                {
                  className: p()('deselect-thumbnails', { disabled: N }),
                  onClick: function () {
                    k({});
                  },
                  disabled: N,
              ...
              o.a.createElement(h.a, {
                ...
                onClick: function () {
                  return (e = V()), c(l, b, e), void n();
                  var e;
                },
                label: m('action.replace'),
                disabled: (function () {
                  if (b.length < 1 || G) return !0;
                  for (var e in j) if (j[e]) return !1;
                  return !0;
                })(),
              })
            )
      ...
      var T = o.a.forwardRef(function (e, t) {
        var n = u.a.getDocument();
        return o.a.createElement(
          A,
          L({}, e, { documentInViewer: n, replacePagesHandler: N.n, ref: t })
        );
      });
      T.displayName = 'FileSelectedPanelContainer';
      var F = T,
        I = n(23);
      function R(e) {
        return (R =
      ...
      function M() {
        ...
        var h = Object.getPrototypeOf,
          y = h && h(h(j([])));
        y && y !== t && n.call(y, a) && (b = y);
        var g = (f.prototype = s.prototype = Object.create(b));
        function v(e) {
        ...
        return (
          ...
          (m.displayName = c(f, l, 'GeneratorFunction')),
      ...
      var G = new RegExp(
        ...
        W = { loadAsPDF: !0, l: window.sampleL },
        z = function (e) {
          var t = e.closeModal,
            n = e.selectableFiles,
            a = e.isOpen,
            i = e.selectedThumbnailPageIndexes,
            c = e.selectedTab,
            y = H(Object(d.a)(), 1)[0],
            g = H(Object(r.useState)({}), 2),
            v = g[0],
            x = g[1],
            E = H(Object(r.useState)(null), 2),
            P = E[0],
            O = E[1],
            S = H(Object(r.useState)(!1), 2),
            j = S[0],
            k = S[1],
            A = H(Object(r.useState)(null), 2),
            L = A[0],
            T = A[1],
            R = Object(l.d)();
          Object(r.useEffect)(
          ...
          var _ = function () {
              O(null), k(!1);
              var e = Object(I.a)().querySelector(
                '#'.concat('pageReplacementFileInputId')
              );
              e && (e.value = null), t(), T(null), x({});
            },
            B = function () {
              return Object(N.d)(_, R);
            },
            z = p()({
              Modal: !0,
                  ...
                  return M().wrap(function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          if (
                            (k(!0), !U || 'customFileListPanelButton' !== L)
                          ) {
                            e.next = 9;
                            break;
                          }
                        ...
                        case 9:
                          ...
                          return (e.next = 12), u.a.createDocument(U, W);
                        case 12:
                          (t = e.sent), O(t);
                        case 14:
                        case 'end':
                    ...
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          ...
                          break;
                        case 4:
                          return (e.next = 6), u.a.createDocument(t, W);
                        case 6:
                          n = e.sent;
                        case 7:
                          O(n), k(!0);
            ...
            Y = void 0 === U;
          'urlInputPanelButton' !== L || G.test(U) || (Y = !0);
          var J,
            q = function () {
              O(null), k(!1);
            };
                  ...
                  : ((J = n && n.length > 0),
                    o.a.createElement(
                      ...
                      o.a.createElement(
                        ...
                        {
                          isOpen: a,
                          title: y('component.pageReplaceModalTitle'),
                          closeButtonDataElement: 'pageReplacementModalClose',
                          onCloseClick: _,
                          swipeToClose: !0,
                          closeHandler: _,
                            ...
                            o.a.createElement(
                                ...
                                o.a.createElement(
                                  ...
                                  o.a.createElement(
                                    ...
                                    o.a.createElement(
                                      ...
                                      y('option.pageReplacementModal.yourFiles')
                                    )
                                  ),
                                  o.a.createElement('div', {
                              ...
                              o.a.createElement(
                                ...
                                o.a.createElement(
                                  'button',
                                  { className: 'tab-options-button' },
                                  y('option.pageReplacementModal.localFile')
                                )
                              )
                            )
                          ),
                        ...
                        o.a.createElement(
                          ...
                          { className: 'footer' },
                          o.a.createElement(h.a, {
                            className: p()('modal-btn', { noFile: Y }),
                            onClick: function () {
                              return Y ? null : V();
                            },
                            label: y('action.select'),
                            disabled: Y,
                          })
                        )
                      )
      ...
      var K = function (e) {
          var t = e.closePageReplacement,
            ...
            i = Y(Y({}, n), {}, { closeModal: a });
          return o.a.createElement(z, i);
        },
        X = n(5);
      function Q(e) {
        return (Q =
        ...
        var t = Object(l.d)(),
          ...
          r = ne(
            Object(l.e)(function (e) {
              return [a.a.isElementOpen(e, X.a.PAGE_REPLACEMENT_MODAL)];
            }),
            1
          )[0],
          ...
          p = Object(l.e)(function (e) {
            return a.a.getSelectedTab(e, X.a.PAGE_REPLACEMENT_MODAL);
          }),
          u = ee(
            ee({}, e),
            {},
            {
              closePageReplacement: function () {
                t(i.a.closeElement(X.a.PAGE_REPLACEMENT_MODAL));
              },
              selectableFiles: n,
              isOpen: r,
