  ...
  [46],
  {
    ...
    1735: function (e, t, n) {
      ...
      var y = window.Core.Scale,
        M = {
          scale: w.a.array,
          onScaleChange: w.a.func,
          precision: w.a.number,
        };
      function E(e) {
        var t = e.scale,
          n = e.onScaleChange,
          ...
          l = S(
            Object(i.e)(function (e) {
              return [b.a.getMeasurementUnits(e)];
            }, i.c),
            1
          )[0],
          s = S(Object(a.useState)(''), 2),
          d = s[0],
          m = s[1],
          f = S(Object(a.useState)(''), 2),
          h = f[0],
          w = f[1],
          v = S(Object(a.useState)(!1), 2),
          M = v[0],
          E = v[1],
          A = S(Object(a.useState)(''), 2),
          j = A[0],
          O = A[1],
          _ = S(Object(a.useState)(''), 2),
          k = _[0],
          C = _[1],
          D = S(Object(a.useState)(!1), 2),
          N = D[0],
          I = D[1],
        ...
        Object(a.useEffect)(
          function () {
            U.includes(t[0][1]) || J(U[0], !0);
          },
          [t[0][1]]
        ),
          Object(a.useEffect)(
            function () {
              U.includes(t[0][1]) && !H.includes(t[1][1]) && J(H[0], !1);
            },
            [t[0][1], t[1][1]]
          ),
          Object(a.useEffect)(
            function () {
              ...
              t[0][0] &&
                (null == T ? void 0 : T.current) !== document.activeElement &&
                m(
                  M
                    ? y.getFormattedValue(t[0][0], t[0][1], c, !1, !0) || ''
                    : e(t[0][0]) || ''
                ),
                !t[1][0] ||
                  (L && L.current === document.activeElement) ||
                  (M || 'ft-in' === t[1][1]
                    ? w(y.getFormattedValue(t[1][0], t[1][1], c, !1, !0) || '')
                    : w(e(t[1][0]) || ''));
            },
            [t, c, L, T, M, N]
          ),
          ...
          Object(a.useEffect)(
            function () {
              M
                ? (O(u.i[t[0][1]]), C(u.i[t[1][1]]))
                : 'ft-in' === t[1][1]
                  ? (O(''), C(u.i['ft-in decimal']))
                  : (O(''), C(''));
            },
            [t, M]
          ),
          ...
          Object(a.useEffect)(
            function () {
              if (F || B)
                !F && G(T.current.value, !0), !B && G(L.current.value, !1);
              else {
                var e = { value: t[0][0], unit: t[0][1] };
                G(T.current.value, !0, function (t) {
                  e = t.pageScale;
                });
                var n = { value: t[1][0], unit: t[1][1] };
                G(L.current.value, !1, function (e) {
                  n = e.worldScale;
                }),
                  K(new y({ pageScale: e, worldScale: n }));
              }
            },
            [M]
          );
        var F = !!t[0][0],
          B = !!t[1][0],
          P = p()('scale-input', { 'invalid-value': !F }),
          V = p()('scale-input', { 'invalid-value': !B }),
          K = function (e) {
            var t = function (e) {
            ...
            e.pageScale.value &&
              e.pageScale.value < c &&
              (e.pageScale.value = t(e.pageScale.unit)),
              e.worldScale.value &&
                e.worldScale.value < c &&
                (e.worldScale.value = t(e.worldScale.unit)),
              n(e);
          },
          G = function (e, n, a) {
            var o = function (e) {
              if ((n && e !== t[0][0]) || (!n && e !== t[1][0])) {
                var o = new y({
                  pageScale: { value: n ? e : t[0][0], unit: t[0][1] },
                  worldScale: { value: n ? t[1][0] : e, unit: t[1][1] },
                });
                a ? a(o) : K(o);
              }
            };
            ...
            if (M) {
              ...
              } else if ('ft-in' === r && u.g.test(i)) {
                var l = Object(u.o)(i);
                if (l > 0) return void o(l);
              }
            } else if (n || 'ft-in' !== t[1][1]) {
              if (u.d.test(i)) {
          ...
          J = function (e, n) {
            ...
            (a =
              n && e !== t[0][1]
                ? {
                    value: t[0][0] ? Object(u.c)(t[0][0], t[0][1], e) : t[0][0],
                    unit: e,
                  }
                : { value: t[0][0], unit: t[0][1] }),
              (o =
                n || e === t[1][1]
                  ? { value: t[1][0], unit: t[1][1] }
                  : {
                      value: t[1][0]
                        ? Object(u.c)(t[1][0], t[1][1], e)
                        : t[1][0],
                      unit: e,
                    }),
              K(new y({ pageScale: a, worldScale: o }));
          },
          W = function (e) {
            var n = e ? t[0][1] : t[1][1];
            return M ? u.i[n] : 'ft-in' === n ? u.i['ft-in decimal'] : '';
          },
          $ = function () {
            I(function (e) {
              return !e;
          ...
          o.a.createElement(
            ...
            o.a.createElement(
              ...
              o.a.createElement(
                ...
                { className: 'input-wrapper' },
                o.a.createElement('input', {
                  type: M || 'ft-in' === t[1][1] ? 'text' : 'number',
                  min: '0',
                  className: V,
                  value: h,
                  'data-element': 'customDisplayScaleValue',
                  onChange: function (e) {
                    return G(e.target.value, !1);
                  },
                  placeholder: W(!1),
                  ref: L,
                  onBlur: $,
          ...
          o.a.createElement(
            ...
            !F &&
              o.a.createElement(
                ...
                ''
                  .concat(
                    R('option.measurement.scaleModal.incorrectSyntax'),
                    ' '
                  )
                  .concat(j)
              ),
        ...
        z = function (e) {
          var t,
            ...
            v = D(
              Object(i.e)(function (e) {
                return [
                  b.a.isElementDisabled(e, j.a.SCALE_MODAL),
                  b.a.isElementOpen(e, j.a.SCALE_MODAL),
                  b.a.isElementHidden(e, j.a.SCALE_MODAL),
                  b.a.getCurrentToolbarGroup(e),
                  b.a.getSelectedScale(e),
                  b.a.getActiveToolName(e),
                  b.a.getIsAddingNewScale(e),
                  b.a.getMeasurementScalePreset(e),
                  b.a.getCalibrationInfo(e),
                  b.a.getIsMultipleScalesMode(e),
                ];
              }),
              10
            ),
            ...
            F = v[8],
            B = F.tempScale,
            P = F.isFractionalUnit,
            V = v[9],
            K = D(Object(a.useState)(!1), 2),
            G = K[0],
            J = K[1],
            W = D(Object(a.useState)(u.r[u.a.DECIMAL][0]), 2),
            $ = W[0],
            q = W[1],
            Q = D(Object(a.useState)(L), 2),
            X = Q[0],
            Y = Q[1],
            Z = D(Object(a.useState)(H[u.b.METRIC][0]), 2),
            ee = Z[0],
            te = Z[1],
            ne = D(Object(a.useState)(new T('')), 2),
            ae = ne[0],
            oe = ne[1],
            ie = D(Object(a.useState)(!1), 2),
            re = ie[0],
            ce = ie[1],
            le = Object.keys(m.a.getScales()).length;
          Object(a.useEffect)(
            function () {
              u.r[be].includes($) || q(u.r[be][0]), te(H[me][0]);
            },
            [G]
          ),
            Object(a.useEffect)(
              function () {
                Y(L), oe(new T(I.getScaleRatioAsArray()));
                var e = m.a.getScalePrecision(I);
                if (e) {
                  var t = Object(u.j)(e);
                  J(t);
                  var n = u.r[fe(t)].find(function (t) {
                    return t[1] === e;
                  });
                  q(n),
                    setTimeout(function () {
            ...
            Object(a.useEffect)(
              function () {
                !E &&
                  B &&
                  (oe(new T(B)),
                  w(f.a.updateCalibrationInfo({ isCalibration: !1 })),
                  J(P));
              },
              [E]
            ),
            ...
            Object(a.useEffect)(
              function () {
                M && U && !B && (Y(L), oe(u.l), J(!1), q(u.r[u.a.DECIMAL][0]));
              },
              [M, U]
            );
          var se = function () {
              w(f.a.closeElement(j.a.SCALE_MODAL));
            },
            de = function () {
              var e = function (e, t) {
                var n = e,
                ...
                return (
                  G
                    ? ('ft-in' === t && (a /= 12), (n = Math.round(n / a) * a))
                    : 'ft-in' !== t &&
                      (n = n.toFixed((1 / a).toString().length - 1)),
                  1 * n
                );
              };
              if (ue) {
                var t = ae.getScaleRatioAsArray();
                return (
                  (t[0][0] = e(t[0][0], t[0][1])),
                  (t[1][0] = e(t[1][0], t[1][1])),
                  t
              ...
              return ee[1].toString();
            },
            pe = p()('Modal', 'ScaleModal', { open: !E, closed: E }),
            ue = X === L,
            me = G ? u.b.IMPERIAL : u.b.METRIC,
            fe = function (e) {
              return e ? u.a.FRACTIONAL : u.a.DECIMAL;
            },
            be = fe(G),
            he = !ue || ae.isValid(),
            we =
              ...
              !(
                u.e.includes(
                  null === (t = ae.pageScale) || void 0 === t ? void 0 : t.unit
                ) &&
                u.e.includes(
                  null === (n = ae.worldScale) || void 0 === n ? void 0 : n.unit
                )
              );
          return (
            !y &&
            o.a.createElement(
              ...
              o.a.createElement(
                ...
                o.a.createElement(
                  'div',
                  { className: pe, 'data-element': j.a.SCALE_MODAL },
                  o.a.createElement(
                    'div',
                    { className: 'container' },
                    o.a.createElement(
                      ...
                      o.a.createElement(
                        ...
                        o.a.createElement(
                          'p',
                          null,
                          S('option.measurementOption.scale')
                        ),
                            ...
                            o.a.createElement(
                              'button',
                              {
                                ...
                                onMouseDown: function () {
                                  ...
                                  var t = ue
                                    ? (null === (e = ae.worldScale) ||
                                      void 0 === e
                                        ? void 0
                                        : e.unit) || ''
                                    : ee[1].worldScale.unit;
                                  w(
                          ...
                          o.a.createElement(
                            ...
                            o.a.createElement(
                              ...
                              o.a.createElement(x.a, {
                                ...
                                items: H[me].map(function (e) {
                                  return e[0];
                                }),
                                currentSelectionKey: ee[0],
                      ...
                      o.a.createElement(
                        'button',
                        {
                          onClick: function () {
                            ...
                            (e = new T(de(), $[1])),
                              (t = [].concat(C(d), [h])),
                              m.a.createAndApplyScale(e, t),
                              se();
                          },
                          className: 'scale-create',
                          'data-element': 'createScale',
                          disabled: !he || (!V && le) || (!U && !re),
                        },
                        S('action.create')
                      )
                    )
