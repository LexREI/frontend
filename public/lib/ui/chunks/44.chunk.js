(window.webpackJsonp = window.webpackJsonp || []).push([
  [44],
  {
    ...
    1737: function (e, t, n) {
      ...
      var P = {
          closeModal: y.a.func,
          currentPage: y.a.number,
          pageLabels: y.a.array,
          selectedPages: y.a.array,
          markPages: y.a.func,
          redactPages: y.a.func,
          evenDisabled: y.a.bool,
          renderCanvases: y.a.func,
          isOpen: y.a.bool,
        },
        A = 'current',
        k = 'specify',
        ...
        j = function (e) {
          var t = e.closeModal,
            ...
            x = e.isOpen,
            y = Object(f.a)().t,
            M = R(Object(o.useState)(A), 2),
            P = M[0],
            j = M[1],
            C = R(Object(o.useState)(), 2),
            S = C[0],
            D = C[1];
          Object(o.useEffect)(
            function () {
          ...
          var T = function () {
              ...
              if (P === A) return [d];
              if (P === k) return S;
              if (P === E) for (var t = 1; n.length >= t; t += 2) e.push(t);
              else if (P === O)
                for (var o = 2; n.length >= o; o += 2) e.push(o);
              return e;
            },
            L = Object(o.useRef)();
          Object(o.useEffect)(
          ...
          var _ = function (e) {
            ...
            (L.current.clientHeight < L.current.scrollHeight ||
              L.current.clientWidth < L.current.scrollWidth) &&
                ...
                a.a.createElement(
                  ...
                  a.a.createElement(
                    ...
                    a.a.createElement(
                      ...
                      y('option.pageRedactModal.header')
                    ),
                    a.a.createElement(g.a, { onClick: t, img: 'icon-close' })
                  ),
                  a.a.createElement(
                    'div',
                    { className: 'body' },
                    ...
                    a.a.createElement(
                      ...
                      a.a.createElement(
                        'strong',
                        null,
                        y('option.pageRedactModal.pageSelection')
                      ),
                      a.a.createElement(h.a, {
                        checked: P === A,
                        radio: !0,
                        name: 'page-redaction-option',
                        label: y('option.pageRedactModal.current'),
                        value: A,
                      }),
                      a.a.createElement(h.a, {
                        checked: P === k,
                        radio: !0,
                        name: 'page-redaction-option',
                        label: y('option.pageRedactModal.specify'),
                        value: k,
                      }),
                      'specify' === P &&
                        a.a.createElement(v.a, {
                          selectedPageNumbers: S,
                          pageCount: n.length,
                      ...
                      a.a.createElement(h.a, {
                        ...
                        radio: !0,
                        name: 'page-redaction-option',
                        label: y('option.pageRedactModal.odd'),
                        value: E,
                      }),
                      a.a.createElement(h.a, {
                        checked: P === O,
                        radio: !0,
                        name: 'page-redaction-option',
                        label: y('option.pageRedactModal.even'),
                        value: O,
                        disabled: p,
                      })
                    )
      ...
      var _ = function () {
        ...
        var x = function () {
            return e(c.a.closeElement(i.a.PAGE_REDACT_MODAL));
          },
          y = function () {
            return null != f && f.includes('AnnotationCreateRedaction')
              ? g
              : {};
          },
          w = D(Object(o.useState)(!1), 2),
          v = w[0],
          R = w[1];
        return (
          Object(o.useEffect)(function () {
            var e = function () {
              var e = l.a.getDocument(),
                t = e.getDocumentCompletePromise();
              null == t ||
                t.then(function () {
                  var t = e.getPageCount();
                  R(t < 2);
                });
            };
            return (
              ...
              function () {
                return l.a.removeEventListener('documentLoaded', e);
              }
            );
          }, []),
          a.a.createElement(C, {
            evenDisabled: v,
            closeModal: x,
            renderCanvases: function (e, t) {
              var o;
              h.current++;
              for (
                var a = h.current, i = S(t), r = l.a.getDocument();
                e.current.firstChild;

              )
                e.current.removeChild(e.current.firstChild);
              if (i) {
                (null === (o = i) || void 0 === o ? void 0 : o.length) > 10 &&
                  (i = i.splice(0, 10));
                var d,
                  c = (function (e, t) {
                    var n =
                ...
                try {
                  for (c.s(); !(d = c.n()).done; ) {
                    var p = d.value,
                      s = null == r ? void 0 : r.getPageInfo(p);
                    if (n && r && e.current && s) {
                      var u = 1,
                        m = e.current.getBoundingClientRect(),
                        f =
                          parseInt(
