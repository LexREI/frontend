    ...
    1731: function (e, t, a) {
      ...
      var T = function () {
        var e,
          ...
          A = n[7],
          D = u < 1e3,
          j = c.a.getDocumentViewer(),
          B = null == j ? void 0 : j.getDisplayModeManager();
        B && B.isVirtualDisplayEnabled() && (D = !0);
        var F,
          S,
          V = !C.g && !A,
          L = function (e, t) {
            var n = function () {
              var a = r.find(function (a) {
        ...
        I && ((F = I.pageTransition), (S = I.layout));
        var P =
        ...
        return s.a.createElement(
          ...
          D &&
            s.a.createElement(
              ...
              s.a.createElement(
                E.a,
                { dataElement: 'pageTransitionHeader', className: 'type' },
                t('option.displayMode.pageTransition')
              ),
              s.a.createElement(
                E.a,
                {
                  className: o()({ row: !0, active: 'continuous' === F && !h }),
                  onClick: function () {
                    return L('continuous', S);
                  },
              ...
              s.a.createElement(
                E.a,
                {
                  className: o()({ row: !0, active: 'default' === F && !h }),
                  onClick: function () {
                    return L('default', S);
                  },
          ...
          !h &&
            s.a.createElement(
              ...
              s.a.createElement(
                E.a,
                { dataElement: 'rotateHeader', className: 'type' },
                t('action.rotate')
              ),
              s.a.createElement(
                E.a,
              ...
              s.a.createElement(
                E.a,
                {
                  className: 'row',
                  onClick: function () {
                    return c.a.rotateCounterClockwise(O);
                  },
              ...
              s.a.createElement(
                E.a,
                { dataElement: 'layoutHeader', className: 'type' },
                t('option.displayMode.layout')
              ),
              s.a.createElement(
                E.a,
                {
                  className: o()({ row: !0, active: 'single' === S }),
                  onClick: function () {
                    return L(F, 'single');
                  },
              ...
              s.a.createElement(
                E.a,
                {
                  className: o()({ row: !0, active: 'double' === S }),
                  onClick: function () {
                    return L(F, 'double');
                  },
              ...
              s.a.createElement(
                E.a,
                {
                  className: o()({ row: !0, active: 'cover' === S }),
                  onClick: function () {
                    return L(F, 'cover');
                  },
              ...
              V &&
                s.a.createElement(
                  E.a,
                  {
                    className: o()({ row: !0, active: k }),
                    onClick: function () {
                      a.dispatch(y.a.setIsMultiViewerMode(!k));
                    },
