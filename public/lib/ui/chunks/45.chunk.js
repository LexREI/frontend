    ...
    1746: function (e, t, n) {
      ...
      function _() {
        ...
        function d(e, t, n, a) {
          var r = t && t.prototype instanceof s ? t : s,
            ...
            c = new k(a || []);
          return o(i, '_invoke', { value: w(e, n, c) }), i;
        }
        function p(e, t, n) {
          try {
        ...
        var v = Object.getPrototypeOf,
          b = v && v(v(j([])));
        b && b !== t && n.call(b, r) && (h = b);
        var y = (m.prototype = s.prototype = Object.create(h));
        function g(e) {
                ...
                return new t(function (a, i) {
                  !(function o(a, r, i, c) {
                    ...
                    if ('throw' !== l.type) {
                      var d = l.arg,
                        u = d.value;
                      return u && 'object' == O(u) && n.call(u, '__await')
        ...
        function w(e, t, n) {
          ...
          return function (a, r) {
            ...
            for (n.method = a, n.arg = r; ; ) {
              ...
              if ('normal' === l.type) {
                if (
                  ((o = n.done ? 'completed' : 'suspendedYield'), l.arg === u)
                )
                  continue;
        ...
        return (
          ...
          (f.displayName = l(m, c, 'GeneratorFunction')),
      ...
      var D = 'all',
        ...
        T = function () {
          var e = Object(r.f)(),
            ...
            v = L(
              Object(r.e)(function (e) {
                return [
                  i.a.isElementOpen(e, d.a.SAVE_MODAL),
            ...
            O = v[1],
            A = [C.PDF, C.IMAGE],
            T = L(Object(o.useState)(A), 2),
            G = T[0],
            R = T[1],
            z = L(Object(o.useState)(''), 2),
            H = z[0],
            V = z[1],
            B = L(Object(o.useState)(G[0]), 2),
            U = B[0],
            W = B[1],
            J = L(Object(o.useState)(D), 2),
            K = J[0],
            Y = J[1],
            $ = L(Object(o.useState)(), 2),
            q = $[0],
            Q = $[1],
            X = L(Object(o.useState)(!0), 2),
            Z = X[0],
            ee = X[1],
            te = L(Object(o.useState)(!1), 2),
            ne = te[0],
            oe = te[1],
            ae = L(Object(o.useState)(1), 2),
            re = ae[0],
            ie = ae[1],
            ce = L(Object(o.useState)(''), 2),
            le = ce[0],
            de = ce[1];
          Object(o.useEffect)(
            function () {
              ...
              return (
                !ve && window.addEventListener('keydown', e),
                function () {
                ...
                var e = (function () {
                          ...
                          return _().wrap(function (e) {
                            for (;;)
                              switch ((e.prev = e.next)) {
                                ...
                                case 16:
                                  a === S.a.OFFICE_EDITOR &&
                                    (R([C.OFFICE_EDITOR, C.PDF]),
                                    W(C.OFFICE_EDITOR));
                                case 17:
                                  ie(h.a.getTotalPages(O));
                                case 18:
                                case 'end':
                                  return e.stop();
                              }
                  ...
                  n = function () {
                    V(''),
                      ...
                      R(A),
                      W(A[0]),
                      t(c.a.closeElement(d.a.SAVE_MODAL));
                  };
                return (
                  e(),
                  h.a.addEventListener('documentUnloaded', n, void 0, O),
                  h.a.addEventListener('documentLoaded', e, void 0, O),
                  function () {
                    h.a.removeEventListener('documentUnloaded', n, O),
                      h.a.removeEventListener('documentLoaded', e, O);
                  }
                );
              },
              [O]
            ...
            Object(o.useEffect)(
              function () {
                var e = h.a.getDocument(O);
                if (Object(E.a)() && e) {
                  W(C.OFFICE_EDITOR);
                  var t = e.getFilename(),
                    n = t.substring(0, t.lastIndexOf('.')) || t;
                  V(n);
                }
              },
              [M]
          ...
          var pe = function () {
              return t(c.a.closeElement(d.a.SAVE_MODAL));
            },
            ue = function () {
              return de('');
            },
              ...
              H &&
                ((n =
                  K === I
                    ? null != q && q.length
                      ? q
                      : [h.a.getCurrentPage(O)]
                    : K === F || K === N
                      ? [h.a.getCurrentPage(O)]
                      : k()(1, h.a.getTotalPages(O) + 1, 1)),
                Object(w.a)(
                  t,
                  {
            ...
            fe = L(Object(o.useState)(!1), 2),
            me = fe[0],
            he = fe[1],
            ve = ((le || !me) && K === I) || !H,
            be = 'office' === U.extension || Object(E.a)();
          return a.a.createElement(
            ...
            a.a.createElement(
              ...
              a.a.createElement(
                'div',
                {
                  className: b()('SaveModal', { open: M, closed: !M }),
                  'data-element': d.a.SAVE_MODAL,
                },
                a.a.createElement(
                  'div',
                  { className: 'container' },
                  ...
                  a.a.createElement(
                    ...
                    a.a.createElement(
                      ...
                      a.a.createElement(s.a, {
                        ...
                        fillWidth: 'false',
                        messageText:
                          '' === H ? n('saveModal.fileNameCannotBeEmpty') : '',
                        message: '' === H ? 'warning' : 'default',
                      })
                    ),
                    a.a.createElement(
                      'div',
                      ...
                      a.a.createElement(y.a, {
                        ...
                        onClickItem: function (e) {
                          W(
                            ...
                            e === C.OFFICE.label && Y(D);
                        },
                        currentSelectionKey: U.label,
                      })
                    ),
                    !be &&
                      a.a.createElement(
                        ...
                        a.a.createElement(
                          ...
                          a.a.createElement(f.a, {
                            ...
                            radio: !0,
                            name: 'page-range-option',
                            label: n('option.print.specifyPages'),
                            value: I,
                          }),
                          K === I &&
                            a.a.createElement(
                              'div',
                              {
                                className: b()('page-number-input-container', {
                                  error: !!le,
                                }),
                              },
                              a.a.createElement(g.a, {
                                selectedPageNumbers: q,
                                pageCount: re,
                                onBlurHandler: Q,
                                onSelectedPageNumbersChange: function () {
                                  me || he(!0), ue();
                                },
                                placeHolder: x.a,
                                onError: function () {
                                  return de(n('saveModal.pageError') + re);
                                },
                              }),
                              le &&
                                a.a.createElement(
