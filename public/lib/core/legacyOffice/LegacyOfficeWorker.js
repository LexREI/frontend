!(function (e) {
  ...
  function (e, t) {
    ...
    function d() {
      f &&
        u &&
        ((f = !1), u.length ? (c = u.concat(c)) : (l = -1), c.length && m());
    }
    function m() {
      if (!f) {
        var e = s(d);
  ...
  function (e, t, n) {
    ...
    var O,
      ...
      R =
        ...
        (S =
          /(msie) ([\w.]+)/.exec(O) || /(trident)(?:.*? rv:([\w.]+)|)/.exec(O))
          ? parseInt(S[2], 10)
          : S),
      W =
      ...
      U =
        ...
        (/^((?!chrome|android).)*$/.test(L.navigator.userAgent) && C),
    ...
    var q = (function () {
      ...
      X = function (e, t, n) {
        ...
        if ($() && !n) {
          ...
          (self.Module.memoryInitializerRequest = new q(s)),
            (o = new Blob([r], { type: 'application/javascript' })),
            importScripts(URL.createObjectURL(o));
        }
      };
