...
*****************************************************************************/
  ...
  var $jscomp$lookupPolyfilledValue = function (v, x, u) {
    if (!u || null != v) {
      u = $jscomp.propertyToPolyfillSymbol[x];
  ...
  $jscomp.polyfill = function (v, x, u, n) {
    x &&
      ($jscomp.ISOLATE_POLYFILLS
        ? $jscomp.polyfillIsolated(v, x, u, n)
        : $jscomp.polyfillUnisolated(v, x, u, n));
  };
    ...
    function (v) {
      function x() {
        ...
        try {
          ...
          if (2 != p.get(g) || 3 != p.get(k)) return !1;
          p.delete(g);
          p.set(k, 4);
      ...
      function r(g) {
        if (!$jscomp.owns(g, l)) {
          var k = new u();
          $jscomp.defineProperty(g, l, { value: k });
        }
      }
      function y(g) {
      ...
      e.prototype.set = function (g, k) {
        if (!n(g)) throw Error('Invalid WeakMap key');
        r(g);
        if (!$jscomp.owns(g, l)) throw Error('WeakMap key fail: ' + g);
        g[l][this.id_] = k;
        return this;
      };
      e.prototype.get = function (g) {
        return n(g) && $jscomp.owns(g, l) ? g[l][this.id_] : void 0;
      };
      e.prototype.has = function (g) {
        return n(g) && $jscomp.owns(g, l) && $jscomp.owns(g[l], this.id_);
      };
  ...
  $jscomp.polyfill(
    ...
    function (v) {
      function x() {
        ...
        try {
          var e = Object.seal({ x: 4 }),
            g = new v($jscomp.makeIterator([[e, 's']]));
          if (
            's' != g.get(e) ||
            1 != g.size ||
            g.get({ x: 4 }) ||
      ...
      n.prototype.forEach = function (e, g) {
        for (var k = this.entries(), p; !(p = k.next()).done; )
          (p = p.value), e.call(g, p[1], p[0], this);
      };
  ...
  $jscomp.polyfill(
    ...
    function (v) {
      ...
      r.prototype.resolveToNonPromiseObj_ = function (l) {
        ...
        'function' == typeof d
          ? this.settleSameAsThenable_(d, l)
          : this.fulfill_(l);
      };
      ...
      r.prototype.then = function (l, d) {
        ...
        this.callWhenSettled_(e(l, g), e(d, k));
        return p;
      };
      ...
      r.race = function (l) {
        return new r(function (d, e) {
          for (
            var g = $jscomp.makeIterator(l), k = g.next();
            !k.done;
            k = g.next()
          )
        ...
        return e.done
          ...
          : new r(function (g, k) {
              ...
              do
                m.push(void 0),
                  A++,
                  u(e.value).callWhenSettled_(p(m.length - 1), k),
                  (e = d.next());
              while (!e.done);
            });
      };
  ...
  (function (v) {
    ...
    x.t = function (n, r) {
      r & 1 && (n = x(n));
      if (r & 8 || (r & 4 && 'object' === typeof n && n && n.__esModule))
        return n;
      ...
      var n = u(2),
        r = function (g, k) {
          Object(n.a)('disableLogs') ||
            (k ? console.warn(g + ': ' + k) : console.warn(g));
        },
        y = function (g, k) {
          Object(n.a)('disableLogs') ||
            (k ? console.log(g + ': ' + k) : console.log(g));
        },
        l = function (g) {
          if (!Object(n.a)('disableLogs')) throw (console.error(g), Error(g));
        },
        d = function (g, k) {},
        e = function (g, k) {};
    },
    ...
    function (v, x, u) {
      ...
      var n = u(11),
        ...
        g = !1,
        k = function (c, h) {
          g || (e(d.basePath + 'decode.min.js'), (g = !0));
          ...
          return Object(n.a)(void 0, void 0, Promise, function () {
            ...
            return Object(n.b)(this, function (w) {
              switch (w.label) {
                ...
                case 1:
                  w.sent(), (g = !0), (w.label = 2);
                case 2:
                  return (
                    (f = self.BrotliDecode(Object(l.b)(c))),
                    [2, h ? f : Object(l.a)(f)]
                  );
              }
            });
      ...
      (function () {
        ...
        c.prototype.End = function () {
          if (this.remainingDataArrays.length) {
            for (var h = this.arrays, f = 0, w = 0; w < h.length; ++w)
              f += h[w].length;
            f = new Uint8Array(f);
            var G = 0;
      ...
      var m = !1,
        ...
        t = function (c) {
          ...
          f.open('GET', c.url, c.isAsync);
          var w = h && f.overrideMimeType;
          f.responseType = w ? 'text' : 'arraybuffer';
          w && f.overrideMimeType('text/plain; charset=x-user-defined');
          f.send();
          var G = function () {
            var H = Date.now();
            var J = w ? f.responseText : new Uint8Array(f.response);
            ...
            J.length < c.compressedMaximum
              ? ((J = c.decompressFunction(J, c.shouldOutputArray)),
                ...
                e &&
                  Object(r.a)('worker', 'Decompressed length is ' + J.length))
              : h && (J = Object(l.a)(J));
            e &&
              Object(r.a)(
                'worker',
                c.url + ' Decompression took ' + (Date.now() - H)
              );
            return J;
          };
          if (c.isAsync)
            ...
            if (200 === f.status || 0 === f.status) return G();
        ...
        B = function (c) {
          var h = c.lastIndexOf('/');
          -1 === h && (h = 0);
          var f = c.slice(h).replace('.', '.br.');
          e ||
            (f.endsWith('.js.mem')
              ? (f = f.replace('.js.mem', '.mem'))
              : f.endsWith('.js') && (f = f.concat('.mem')));
          return c.slice(0, h) + f;
        },
        D = function (c, h) {
          var f = c.lastIndexOf('/');
          -1 === f && (f = 0);
          var w = c.slice(f).replace('.', '.gz.');
          h.url = c.slice(0, f) + w;
        ...
        F = function (c, h, f) {
          ...
          if (f.isAsync) {
            var G = h[0](c, f);
            for (w = 1; w < h.length; ++w) G = E(G, c, f, h[w]);
            return G;
          }
          for (w = 0; w < h.length; ++w)
            try {
    ...
    function (v, x, u) {
      ...
      var n = function (y) {
          if ('string' === typeof y) {
            for (
              var l = new Uint8Array(y.length), d = y.length, e = 0;
              e < d;
              e++
            )
              l[e] = y.charCodeAt(e);
        ...
        r = function (y) {
          if ('string' !== typeof y) {
            for (var l = '', d = 0, e = y.length, g; d < e; )
              (g = y.subarray(d, d + 1024)),
                (d += 1024),
    ...
    function (v, x, u) {
      ...
      v = (function () {
        ...
        return (q =
          /(msie) ([\w.]+)/.exec(q) || /(trident)(?:.*? rv:([\w.]+)|)/.exec(q))
          ? parseInt(q[2], 10)
          : q;
      })();
      var r = (function () {
      ...
      var l = (function () {
          var q = n.navigator.userAgent.match(
    ...
    function (v, x, u) {
      function n(d, e, g) {
            ...
            ? (Object(r.a)('load', 'Try instantiateStreaming'),
              fetch(Object(y.a)(d))
                ...
                .catch(function (q) {
                  Object(r.a)(
                    'load',
                    'instantiateStreaming Failed ' + d + ' message ' + q.message
                  );
                  return k(!1);
                }))
            : Object(y.b)(d, g, !0, !0).then(function (q) {
                p = Date.now();
        ...
        return k(!!WebAssembly.instantiateStreaming).then(function (A) {
          Object(r.a)(
            'load',
            'WASM compilation took ' + (Date.now() - (p || m)) + ' ms'
          );
          return A;
        });
      }
    ...
    function (v, x, u) {
      function n(y, l, d, e) {
        ...
        return new (d || (d = Promise))(function (k, p) {
          ...
          function q(t) {
            t.done ? k(t.value) : g(t.value).then(m, A);
          }
            ...
            try {
              ...
              switch (q[0]) {
                ...
                default:
                  ...
                  if (3 === q[0] && (!m || (q[1] > m[0] && q[1] < m[3])))
                    g.label = q[1];
                  else if (6 === q[0] && g.label < m[1])
                    (g.label = m[1]), (m = q);
                  else if (m && g.label < m[2]) (g.label = m[2]), g.ops.push(q);
                  else {
                    m[2] && g.ops.pop();
                    g.trys.pop();
                    continue;
    ...
    function (v, x) {
      ...
      function l() {
        A &&
          q &&
          ((A = !1), q.length ? (m = q.concat(m)) : (t = -1), m.length && d());
      }
      function d() {
        if (!A) {
          var B = r(l);
      ...
      v.nextTick = function (B) {
        ...
        if (1 < arguments.length)
          for (var I = 1; I < arguments.length; I++) D[I - 1] = arguments[I];
        m.push(new e(B, D));
        1 !== m.length || A || r(d);
      };
      ...
      v.off = g;
      v.removeListener = g;
      v.removeAllListeners = g;
      v.emit = g;
      v.prependListener = g;
      v.prependOnceListener = g;
    ...
    function (v, x, u) {
      (function (n) {
        function r(C) {
          ...
          for (var E = Array(arguments.length - 1), F = 0; F < E.length; F++)
            E[F] = arguments[F + 1];
        ...
        function g() {
          ...
          m.addEventListener
            ? m.addEventListener('message', E, !1)
    ...
    function (v, x, u) {
      ...
      v = (function () {
        ...
        y.prototype.on = function (l, d, e) {
          ...
          g[l] &&
            Object(n.c)('There is already an actionName called "' + l + '"');
          g[l] = [d, e];
        };
        ...
        y.prototype.sendWithPromise = function (l, d, e) {
          ...
          l = { action: l, data: d, callbackId: g, priority: e };
          d = window.createPromiseCapability();
          this.callbacksCapabilities[g] = d;
          try {
            this.postMessage(l);
          } catch (k) {
            d.reject(k);
        ...
        y.prototype.sendWithPromiseReturnId = function (l, d, e) {
          ...
          return { promise: d.promise, callbackId: g };
        };
        ...
        y.prototype.cancelPromise = function (l) {
          ...
          } else Object(n.b)('Cannot cancel callback ' + l);
        };
        y.prototype.postMessage = function (l) {
          Object(r.a)('enableWorkerLogs') &&
            Object(n.d)('PDFWorker', 'Sent ' + JSON.stringify(l));
            ...
            (l instanceof Uint8Array
              ...
              : l instanceof ArrayBuffer
                ...
                : Object.keys(l).forEach(function (g) {
                    l.hasOwnProperty(g) && e.getObjectTransfers(l[g], d);
                  }));
        };
        ...
        y.prototype.handleMessage = function (l) {
          var d = this,
            e = l.data;
          Object(r.a)('enableWorkerLogs') &&
            Object(n.d)('PDFWorker', 'Received ' + JSON.stringify(e));
          var g = this.actionHandler,
          ...
          if (e.isReply)
            (g = e.callbackId),
              g in l
                ...
                : Object(n.a)('Cannot resolve callback ' + g);
          else if (e.action in g) {
            var m = g[e.action];
            e.callbackId
              ? Promise.resolve()
                  .then(function () {
    ...
    function (v, x, u) {
      ...
      var n = u(3),
        ...
        l = (function () {
          function e(g) {
            var k = this;
            this.promise = g.then(function (p) {
              k.response = p;
              k.status = 200;
            });
          }
          e.prototype.addEventListener = function (g, k) {
            this.promise.then(k);
          };
          return e;
        })(),
        d = function (e, g, k) {
          if (Object(y.a)() && !k) {
            self.Module.instantiateWasm = function (m, A) {
              return Object(r.a)(e + 'Wasm.wasm', m, g['Wasm.wasm']).then(
                function (q) {
                  A(q.instance);
                }
              );
            ...
            if (g.disableObjectURLBlobs) {
              importScripts(e + 'Wasm.js');
              return;
            }
            k = Object(n.b)(e + 'Wasm.js.mem', g['Wasm.js.mem'], !1, !1);
          } else {
            if (g.disableObjectURLBlobs) {
              importScripts(
      ...
      (function (n, r) {
        ...
        (function (l) {
          ...
          var F = 'pending',
            ...
            c = 'rejected',
            h = function () {},
            f = 'undefined' !== typeof r ? r : setTimeout,
            w = [],
            G;
          I.prototype = {
            constructor: I,
      ...
      (function (n, r) {
        (function (y, l) {
          ...
          function p() {
            ...
            y.addEventListener
              ? y.addEventListener('message', a, !1)
              : y.attachEvent('onmessage', a);
            C = function (b) {
              y.postMessage(F + b, '*');
            };
          }
      ...
      (function (n, r) {
        ...
        (function (l) {
          l.Module = {
            ...
            postPagesUpdatedEvent: function (d, e, g, k) {
              d = { pageDimensions: Module.GetPageDimensions(d) };
              if (g)
                for (var p = 0; p < g.length; ++p)
                  g[p] in d.pageDimensions
                    ? ((d.pageDimensions[g[p]].contentChanged = !0),
                      k && (d.pageDimensions[g[p]].annotationsUnchanged = !0))
                    : console.warn('Invalid Page Number '.concat(g[p]));
            ...
            postPagesRenamedEvent: function (d, e) {
              ...
              for (var k = 1; Module.IteratorHasNext(d); ++k) {
                ...
                g[k] = Module.PageGetId(m);
                Module.IteratorNext(d);
                Module.stackRestore(p);
              }
              Module.postEvent(e, 'pagesRenamed', { pageNumToId: g });
            },
            GetIndividualPageDimensions: function (d, e, g) {
              d = Module.PageGetPageInfo(g);
              d.id = Module.PageGetId(g);
              return d;
            },
            GetPageDimensionsRange: function (d, e, g) {
              for (
                var k = {}, p = Module.PDFDocGetPageIterator(d, e);
                e < g && Module.IteratorHasNext(p);
                ++e
              ) {
            ...
            GetPageDimensions: function (d) {
              try {
                ...
                var g = Module.GetPageCount(d);
                if (0 === g) throw 'This document has no pages.';
                return Module.GetPageDimensionsRange(d, 1, g + 1);
              } finally {
            ...
            loadDoc: function (d, e) {
              ...
              try {
                ...
                d.customHandlerId &&
                  Module._TRN_PDFNetAddPDFTronCustomHandler(d.customHandlerId);
                e = Module.CreateDoc(d, e);
                var p = Module.GetDoc(e);
                if (Module.PDFDocInitSecurityHandler(p))
                  return {
                    docId: e,
                    pageDimensions: Module.GetPageDimensions(p),
                  };
                g = {
                  type: 'NeedsPassword',
                  errorData: { docId: e },
                ...
                g = { type: 'InvalidPDF', message: m };
              } finally {
                Module.stackRestore(k);
              }
              throw g;
            },
            loadCanvas: function (d, e, g, k, p, m, A, q) {
              return new Promise(function (t, B) {
                var D = Module.GetDoc(d),
                  I = e + 1,
                  C = function () {
                    t(Module.RasterizePage(D, I, g, k, m, p, A, q, d));
                  },
            ...
            onRuntimeInitialized: function () {
              ...
              (function (d) {
                d.PDFDocExportXFDF = function (e, g) {
                  e = Module.GetDoc(e);
                  var k = Module.stackSave();
                  try {
                    var p = g
                      ? Module.PDFDocFDFExtract(e, g)
                      : Module.PDFDocFDFExtract(e);
                ...
                d.PageArrayToPageSet = function (e) {
                  ...
                  try {
                    ...
                    for (var p = 0; p < e.length; ++p)
                      Module.PageSetAddPage(k, e[p]);
                    Module.stackRestore(g);
                  } catch (m) {
                    throw (Module.stackRestore(g), m);
                  }
                  return k;
                };
                d.cancelCurrent = function () {
                  ...
                  return e
                    ...
                    : (e = Module.cleanupState)
                      ? (n(e.timeout),
                        e.cleanupArr.reverse().forEach(function (g) {
                          g();
                        }),
                ...
                d.XFDFMerge = function (e, g, k) {
                  if (g) {
                    ...
                    try {
                      ...
                      var A = Module.GetUStringFromJSString(g, !0);
                      m.push(function () {
                        Module.UStringDestroy(A);
                      });
                      var q = Module.allocate(4, 'i8', Module.ALLOC_STACK);
                      REX(Module._TRN_FDFDocCreateFromXFDF(A, q));
                      var t = Module.getValue(q, 'i8*');
                      m.push(function () {
                        Module.FDFDocDestroy(t);
                      });
                      var B = Module.PDFDocFDFUpdate(p, t, k);
                      B &&
                        B.length &&
                        Module.postEvent(e, 'apRefChanged', {
                          apRefChanges: B,
                        });
                    } finally {
                      m.reverse().forEach(function (D) {
                        D();
                      });
                    }
                  }
                };
                d.MergeXFDF = function (e, g, k) {
                ...
                d.CreateBufferFile = function (e, g, k) {
                  Module.MakeDev(e);
                  var p = new ArrayBuffer(g);
                  p = new Uint8Array(p);
                  k = k ? 0 : 255;
                  for (var m = 0; m < g; ++m) p[m] = k;
                  Module.docs[e] = { buffer: p };
                };
                d.ReadBufferFile = function (e, g) {
                  var k = Module.docs[e].buffer;
                  g &&
                    (Module.docs[e].buffer = new Uint8Array(k.buffer.slice(0)));
                  return k;
                };
                d.RemoveBufferFile = function (e) {
                  Module.docs[e] = null;
                };
                d.SaveHelper = function (e, g, k) {
                  k = 'undefined' === typeof k ? 2 : k;
                  Module.MakeDev(g);
                  var p = Module._TRN_PDFDocSave(
                    e,
                  ...
                  REX(p);
                  k & 16 && Module.postPagesRenamedEvent(e, g);
                  return Module.docs[g].buffer.buffer;
                };
                d.SaveDoc = function (e, g, k, p, m, A, q, t, B) {
                  return new Promise(function (D, I) {
                    ...
                    try {
                      ...
                      if (p) {
                        ...
                        (f = Module.ObjFindObj(M, 'OpenAction')) &&
                          Module.ObjPut(M, '__OpenActionBackup__', f);
                ...
                d.SaveDocFromFixedElements = function (e, g, k, p, m, A) {
                  e = Module.PDFDocCreateFromLayoutEls(e);
                  e = Module.CreateDoc({ type: 'ptr', value: e });
                  return Module.SaveDoc(e, g, !0, !1, k, p, m, A);
                };
                d.GetCurrentCanvasData = function (e) {
                  var g = Module.currentRenderData;
                  if (!g) return null;
                  e && REX(Module._TRN_PDFRasterizerUpdateBuffer(g.rast));
                  var k = Date.now();
                  if (g.bufPtr) {
                    e = new Uint8Array(new ArrayBuffer(g.buf_size));
                    for (var p = 0, m = 0; m < g.out_height; ++m)
                      for (
                        var A = g.bufPtr + g.stride * m, q = 0;
                        q < g.out_width;
                        ++q
                      )
                ...
                d.RasterizePage = function (e, g, k, p, m, A, q, t, B) {
                  return new Promise(function (D, I) {
                    ...
                    try {
                      ...
                      if (q) {
                        ...
                        0 !== h &&
                          (REX(
                            Module._TRN_PDFRasterizerSetOCGContext(C.rast, h)
                          ),
                          E.push(function () {
                      ...
                      t.hasOwnProperty('caching') &&
                        REX(
                          Module._TRN_PDFRasterizerSetCaching(C.rast, t.caching)
                        );
                      t.hasOwnProperty('expGamma') &&
                        REX(
                          Module._TRN_PDFRasterizerSetGamma(C.rast, t.expGamma)
                        );
                      ...
                      if (m) {
                        ...
                        (O = Module.PageGetDefaultMatrix(a, A)),
                          (K = C.out_width / (w ? c : b));
                      ...
                      t.useProgress &&
                        Module.postProgressiveRenderingStartEvent(B, g);
                      var X = r(function T() {
                        try {
                          if (
                            (REX(
                ...
                d.UpdatePassword = function (e, g) {
                  try {
                    var k = Module.stackSave();
                    var p = Module.GetDoc(e);
                    return Module.PDFDocInitStdSecurityHandler(p, g)
                ...
                d.InsertBlankPages = function (e, g, k, p) {
                  return new Promise(function (m, A) {
                    ...
                    try {
                      ...
                      for (var D = g.length - 1; 0 <= D; --D) {
                        var I = Module.PDFDocGetPageIterator(t, g[D]),
                ...
                d.InsertPages = function (e, g, k, p, m, A) {
                  return new Promise(function (q, t) {
                    ...
                    try {
                      ...
                      if (g instanceof ArrayBuffer) {
                        var C = Module.CreateDoc(g);
                        var E = Module.GetDoc(C);
                        B[B.length] = function () {
                          Module.DeleteDoc(C);
                        };
                      } else E = Module.GetDoc(g);
                      for (
                        var F = k.length, a = Module.PageSetCreate(), b = 0;
                        b < F;
                        ++b
                      )
                        Module.PageSetAddPage(a, k[b]);
                      A
                        ? Module.PDFDocInsertPages2(D, p, E, a, m)
                ...
                d.MovePages = function (e, g, k) {
                  return new Promise(function (p, m) {
                    ...
                    try {
                      ...
                      for (
                        var B = g.length, D = Module.PageSetCreate(), I = 0;
                        I < B;
                        ++I
                      )
                        Module.PageSetAddPage(D, g[I]);
                  ...
                  return new Promise(function (p, m) {
                    ...
                    try {
                      ...
                      for (var B = g.length - 1; 0 <= B; --B) {
                        var D = Module.PDFDocGetPageIterator(A, g[B]);
                        Module.IteratorHasNext(D) &&
                          (k
                            ? Module.PDFDocPageRemove2(A, D)
                            : Module.PDFDocPageRemove(A, D));
                      }
                      var I;
                ...
                d.RotatePages = function (e, g, k) {
                  return new Promise(function (p, m) {
                    ...
                    try {
                      ...
                      var B = g.length,
                        D = 0,
                        I = Module.PDFDocGetPageIterator(A, g[0]),
                        C = [];
                      q.push(function () {
                      ...
                      for (
                        var E = g[0];
                        Module.IteratorHasNext(I) && D < g[B - 1];
                        ++E
                      ) {
                        if (E === g[D]) {
                ...
                d.ExtractPages = function (e, g, k, p, m, A) {
                  return new Promise(function (q, t) {
                    var B = [];
                    try {
                      ...
                      Module.XFDFMerge(e, k, m);
                      var C = Module.CreateEmptyDoc();
                      B[B.length] = function () {
                        Module.DeleteDoc(C);
                      };
                      var E = Module.InsertPages(C, e, g, 1, !0, A)
                        .then(function () {
                ...
                d.CropPages = function (e, g, k, p, m, A) {
                  return new Promise(function (q, t) {
                    ...
                    try {
                      ...
                      var C = g.length,
                        E = 0,
                        F = Module.PDFDocGetPageIterator(B, g[0]);
                      D.push(function () {
                        Module._TRN_IteratorDestroy(F);
                      });
                      for (
                        var a = [], b = g[0];
                        Module.IteratorHasNext(F) && E < g[C - 1];
                        ++b
                      ) {
                        if (b === g[E]) {
                          ...
                          var f = Module.PageGetRotation(c),
      ...
      (function (n) {
        ...
        (function (d) {
            ...
            read: function (a, b, c) {
              ...
              for (
                var h = this.filePosition % this.chunkSize,
                  f = this.filePosition - h,
                  w = 0;
                0 < c;

              ) {
                if (this.chunkCache.has(f)) var G = this.chunkCache.get(f);
                else
                  (G = new Int8Array(
                    this.reader.readAsArrayBuffer(
                      this.file.slice(f, f + this.chunkSize)
                    )
                  )),
                    this.chunkCache.insert(G, f);
                var z = G.length,
                  H = h + c;
                H <= z
                  ? (a.set(G.subarray(h, H), w),
                    (this.filePosition += c),
                    (c = 0))
          ...
          B.prototype = {
            ...
            getChunk: function (a) {
              ...
              if (this.chunkMap[a]) this.lruUpdate(a);
                ...
                this.customHeaders &&
                  Object.keys(this.customHeaders).forEach(function (f) {
                    h.setRequestHeader(f, b.customHeaders[f]);
                  });
                h.send();
            ...
            getRequiredChunkOffsetArrays: function (a, b) {
              ...
              try {
                ...
                REX(Module._TRN_DownloaderGetRequiredChunksSize(a, b, f));
                var w = Module.getValue(f, 'i8*');
                if (w) {
            ...
            keepVisibleChunks: function (a, b) {
              for (
                var c = b.length, h = Module.chunkMax / 2, f = 0, w = 0;
                w < c;
                ++w
              ) {
                ...
                f += H;
                if (f > h) {
                  this.keepChunks(z.slice(0, H - f + h));
                  break;
                }
            ...
            writeChunk: function (a, b, c) {
              ...
              1048576 !== f || a.buffer.byteLength !== f
                ? (w
          ...
          D.prototype = {
            read: function (a, b, c) {
              var h = this.position + c <= this.length,
                f = h ? c : this.length - this.position;
                ...
                for (w = 0; w < f; ) {
                  ...
                  if (this.chunkStorage.hadChunk(z))
                    (z = this.chunkStorage.getChunk(z).subarray(G, G + H)),
                      ...
                      (w += J),
                      (this.position += J);
                  else for (this.position += H; w < f; ++w) J[w] = 0;
                }
              }
              if (!h) {
                b += f;
          ...
          I.prototype = {
            ...
            write: function (a, b, c) {
              for (var h = this.position + c, f = this.data.length; h > f; ) {
                f = Math.max(f * (16777216 < f ? 1.5 : 2), h);
                var w = new Int8Array(f);
          ...
          d.InsertImageIntoDoc = function (a, b, c) {
            ...
            try {
              ...
              var H = Module.ElementBuilderCreateImage(f, b, 0, 0, G, z),
          ...
          d.DownloaderHint = function (a, b) {
            ...
            if (b.visiblePages) {
              var f = b.visiblePages;
              for (b = 0; b < f.length; ++b) ++f[b];
              Object.keys(h.requirePageCallbacks).forEach(function (G) {
                h.requirePageCallbacks.hasOwnProperty(G) &&
                  f.push(parseInt(G, 10));
              });
              (b = Module.docs[a].chunkStorage) &&
                b.keepVisibleChunks(h.downloader, f);
              a = f.length;
              var w = Module.allocate(4 * a, 'i8', Module.ALLOC_STACK);
              for (b = 0; b < a; ++b) Module.setValue(w + 4 * b, f[b], 'i32');
          ...
          d.RequirePage = function (a, b) {
            return new Promise(function (c, h) {
              h = Module.GetDoc(a);
              var f = downloadDataMap[h];
              !f || f.m_finished_download || f.m_pages[b]
                ? c()
                : (b in f.requirePageCallbacks
                    ? f.requirePageCallbacks[b].push(c)
                    : (f.requirePageCallbacks[b] = [c]),
              ...
              var b = function (c) {
                return function (h) {
                  ...
                  h in downloadDataMap
                    ? c.apply(this, f)
                    : n(function () {
                        h in downloadDataMap && c.apply(this, f);
                      }, 0);
                };
              };
              p = {
                downloadProc: Module.addFunction(function (c, h, f, w, G) {
                  ...
                  m(
                    ...
                    h,
                    f,
                    Module.customHeadersMap[z],
                    Module.withCredentials[z]
                  ).then(function (H) {
                    z in Module.docs &&
                      Module.docs[z].chunkStorage &&
                      Module.docs[z].chunkStorage.writeChunk(H, h);
                    Module._TRN_DownloadComplete(0, h, f, c);
                  });
                }, 'viiiii'),
                notifyUpdatePage: Module.addFunction(
                  b(function (c, h, f, w) {
                    ...
                    if (h in G.requirePageCallbacks)
                      for (
                        f = G.requirePageCallbacks[h], w = 0;
                        w < f.length;
                        ++w
                      )
                        f[w]();
          ...
          d.CreateDocDownloaderBackend = function (a, b, c) {
            ...
            var H = a.downloadData
              ? new F(a.downloadData, h, c, w, G)
              : new F(a.size, h, c, w, G);
            ...
            if ((f = Module._TRN_PDFDocCreateFromFilter(H.downloader, b)))
              Module._TRN_FilterDestroy(H.downloader), REX(f);
              ...
              if (c)
                if ('ptr' === f) Module.docs[b] = { ptr: c };
                  ...
                  if (z) d.CreateDocDownloaderBackend(c, w, b);
                    ...
                    if (
                      H &&
                      ((c = new Uint8Array(c)), 10485760 > c.length + e && !f)
                    ) {
                      e += c.length;
                      var J = c.length,
          ...
          d.ChangeDocBackend = function (a, b) {
            ...
            c
              ? (c.bufPtr &&
                  c.ownership &&
                  (Module._free(c.bufPtr), (e -= c.bufPtrSize)),
          ...
          d.DeleteDoc = function (a) {
            ...
            b
              ? (b.ptr &&
                ...
                b.bufPtr &&
                  b.ownership &&
                  (Module._free(b.bufPtr), (e -= b.bufPtrSize)),
                delete Module.docs[a])
              : Object(y.d)(
                  'Trying to delete document '.concat(
                    a,
          ...
          d.PageGetPageInfo = function (a) {
            ...
            REX(Module._TRN_PageGetPageInfo(a, !0, 1, 0, c, h, b, f));
            return {
              rotation: Module.getValue(f, 'i8*'),
          ...
          d.GetUStringFromJSString = function (a, b) {
            ...
            Module.stringToUTF16(a, f, h);
            a = Module._TRN_UStringCreateFromString(f, c);
            b && Module._free(f);
            REX(a);
          ...
          d.PDFRasterizerRasterizeSeparations = function (a, b, c, h, f, w, G) {
            ...
            c = Array(b);
            for (h = 0; h < b; ++h)
              (f = Module.VectorGetAt(a, h)),
                (c[h] = Module.ExtractSeparationData(f));
          ...
          d.Matrix2DConcat = function (a, b) {
            var c = Module.getValue(b, 'double'),
              ...
              f = Module.getValue(b + 16, 'double'),
              w = Module.getValue(b + 24, 'double'),
              G = Module.getValue(b + 32, 'double');
            b = Module.getValue(b + 40, 'double');
            REX(Module._TRN_Matrix2DConcat(a, c, h, f, w, G, b));
          };
          d.Matrix2DSet = function (a, b, c, h, f, w, G) {
            REX(Module._TRN_Matrix2DSet(a, b, c, h, f, w, G));
          };
          ...
          d.PDFDocInsertPages = function (a, b, c, h, f) {
            REX(Module._TRN_PDFDocInsertPageSet(a, b, c, h, f ? 1 : 0, 0));
          };
          d.PDFDocInsertPages2 = function (a, b, c, h, f) {
            REX(Module._TRN_PDFDocInsertPageSet2(a, b, c, h, f ? 1 : 0, 0));
          };
          ...
          d.ElementBuilderCreateImage = function (a, b, c, h, f, w) {
            var G = Module.allocate(4, 'i8', Module.ALLOC_STACK);
            REX(
              Module._TRN_ElementBuilderCreateImageScaled(a, b, c, h, f, w, G)
            );
          ...
          d.PDFDocFDFUpdate = function (a, b, c) {
            if (c) {
              ...
              c = Module.allocate(8, 'i8', Module.ALLOC_STACK);
              REX(Module._TRN_PDFDocFDFUpdateAppearanceDocs(a, b, w, f, c));
              a = Module.getValue(c, 'i8*');
              b = Module.VectorGetSize(a);
              f = Array(b);
              for (w = 0; w < b; ++w)
                (c = Module.VectorGetAt(a, w)),
                  (f[w] = Module.ExtractApRefChangeData(c));
              Module.VectorDestroy(a);
              if (b) return f;
      ...
      (function (r) {
        r.SetupPDFNetFunctions = function (y) {
          ...
          for (
            ...
            (g = Module._TRN_EMSFunctionIteratorGetNextCommandName(k));

          )
            (g = Module.GetJSStringFromCString(g)), r.queue.onAsync(g, p);
          ...
          if (Module._TRN_EMSCreatePDFNetWorkerInstance) {
            ...
            var A = function (t) {
              if (t in Module.docPtrStringToIdMap)
                return Module.docPtrStringToIdMap[t];
            ...
            k('ExtractPDFNetLayersContext', function (t) {
              ...
              B
                ...
                : Module.PDFDocHasOC(t) &&
                  ((B = Module.PDFDocGetOCGConfig(t)),
                  (D = Module.OCGContextCreate(B)));
    ...
    function (v, x, u) {
      ...
      (function (k) {
        ...
        var m = function () {
          ...
          var t = k.isFull,
            B = t ? 'full/' : 'lean/';
          k.useOptimizedWorker && (B += g.a);
          var D = k.wasmDisabled,
            I = k.disableObjectURLBlobs;
          Object(e.c)();
          k.overriddenPdfWorkerPath &&
            ((q = k.overriddenPdfWorkerPath),
            (k.basePath = '../'),
            !Object(l.a)() || D) &&
            (q = '');
          ...
          setup: function (q) {
            function t(f) {
              var w = f.data,
                G = f.action;
              var z =
                'GetCanvas' === G || 'GetCanvasPartial' === G
                  ? C.shouldRunRender(w)
                  : !0;
              if (z) {
                p = f;
                var H = f.asyncCallCapability;
                Object(e.b)('Memory', 'Worker running command: '.concat(G));
                E.actionMap[G](w, f).then(
                  function (J) {
              ...
              } else k.deferredQueue.queue(f), I();
            }
            function B(f) {
              f.asyncCallCapability = createPromiseCapability();
              p || E.length ? E.queue(f) : t(f);
              return f.asyncCallCapability.promise;
            }
            function D(f) {
              self.shouldResize &&
                C.Initialize(
                  f.options.workerHeapSize,
                  f.options.pdfResourcePath,
                  f.options.pdfAsmPath,
                  f.options.parentUrl
                );
              Module.chunkMax = f.options.chunkMax;
              if (f.array instanceof Uint8Array) {
                var w = 255 === f.array[0];
            ...
            (function () {
              k.queue = E = new n.a({
                ...
                comparator: function (f, w) {
                  return f.priority === w.priority
                    ? f.callbackId - w.callbackId
            ...
            q.on('InitWorker', D);
            var c = function (f) {
                p && f(p) && (Module.cancelCurrent(), (p = null));
                E.removeAllMatching(f, function (w) {
              ...
              h = function (f) {
                c(function (w) {
                  return w.data && w.data.docId === f;
                });
              };
            q.on('UpdatePassword', function (f) {
              return Module.UpdatePassword(f.docId, f.password);
            });
            q.on('LoadRes', function (f) {
              Module.loadResources(f.array, f.l);
              return {};
            });
            q.on('DownloaderHint', function (f) {
              Module.DownloaderHint(f.docId, f.hint);
            });
            q.on('IsLinearized', function (f) {
              return Module.IsLinearizationValid(f.docId);
            });
            q.onNextAsync(I);
            E.onAsync('NewDoc', function (f) {
              return C.NewDoc(f);
            });
            E.onAsync('GetCanvas', function (f) {
              Object(e.b)(
                'workerdetails',
                'Run GetCanvas PageIdx: '
                  .concat(f.pageIndex, ' Width: ')
                  .concat(f.width)
              );
              Object(e.b)(
                'Memory',
            ...
            E.onAsync('GetCanvasPartial', function (f) {
              Object(e.b)(
                'Memory',
            ...
            E.onAsync('SaveDoc', function (f) {
              return Module.SaveDoc(
                f.docId,
                f.xfdfString,
                f.finishedWithDocument,
                f.printDocument,
                f.flags,
                f.watermarks,
                f.apdocs,
                f.password,
                f.encryptionAlgorithmType
              );
            });
            E.onAsync('SaveDocFromFixedElements', function (f) {
            ...
            E.onAsync('MergeXFDF', function (f) {
              return Module.MergeXFDF(f.docId, f.xfdf, f.apdocs);
            });
            E.onAsync('InsertPages', function (f) {
            ...
            E.onAsync('MovePages', function (f) {
              return Module.MovePages(f.docId, f.pageArray, f.destPos);
            });
            E.onAsync('RemovePages', function (f) {
            ...
            E.onAsync('RotatePages', function (f) {
              return Module.RotatePages(f.docId, f.pageArray, f.rotation);
            });
            E.onAsync('ExtractPages', function (f) {
            ...
            E.onAsync('CropPages', function (f) {
            ...
            E.onAsync('TriggerFullDownload', function (f) {
              return Module.TriggerFullDownload(f.docId);
            });
            E.onAsync('InsertBlankPages', function (f) {
            ...
            E.onAsync('RequirePage', function (f, w) {
              return Module.RequirePage(f.docId, f.pageNum);
            });
            q.on('FinishOperation', function () {
              if (p && 'BeginOperation' === p.action) (p = null), I();
              else throw { message: 'Operation has not started.' };
            });
            q.on('DeleteDocument', function (f) {
              f = f.docId;
              h(f);
              Module.DeleteDoc(f);
            });
            q.on('GetCanvasProgressive', function (f) {
              if (p && p.callbackId === f.callbackId) {
                Object(e.b)('worker', 'Progressive request in progress');
                var w = Module.GetCurrentCanvasData(!0);
              } else {
                if (E.find({ priority: 0, callbackId: f.callbackId }))
                  throw (
            ...
            q.on('actionCancel', function (f) {
              p && p.callbackId === f.callbackId
                ...
                : (Object(e.b)('workerdetails', 'Cancelled queued operation'),
                  E.remove({ priority: 0, callbackId: f.callbackId }),
                  k.deferredQueue.remove({
                    priority: 0,
                    callbackId: f.callbackId,
                  }));
            });
        ...
        k.onmessage = function (q) {
          if ('init' === q.data.action) {
            ...
            k.disableObjectURLBlobs = q.data.disableObjectURLBlobs;
